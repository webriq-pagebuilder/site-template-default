  ...
  return (
    <>
      <Head>
        ...
        {/* Agent pages are deliberately kept out of search indexes (the human
            twin is the indexed page) — mirrors the X-Robots-Tag header in
            next.config.mjs. AI crawlers ignore this for fetching. */}
