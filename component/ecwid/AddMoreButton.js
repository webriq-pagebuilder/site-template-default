      ...
      <>
         ...
         <div className="flex flex-col gap-y-4 ">
            ...
            <a
               ...
               className="block w-full text-center text-white font-bold font-heading py-5 px-8 rounded-md uppercase transition duration-200 bg-webriq-darkblue hover:opacity-80"
            >
               Go to Checkout
            </a>
         </div>
