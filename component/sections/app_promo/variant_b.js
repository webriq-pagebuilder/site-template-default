            ...
            <div className="flex flex-wrap items-center justify-center w-1/2">
              {images &&
                (images.length > 1 ? (
                  <>
                    <button
                      className="order-1 md:order-0 lg:order-0 xl:order-0 2xl:order-0 mx-2 md:mr-12 lg:mr-12 xl:mr-12 2xl:mr-12 inline-block p-2 md:p-4 lg:p-4 xl:p-4 2xl:p-4 bg-white rounded-full shadow text-webriq-darkblue hover:text-webriq-babyblue focus:outline-none"
                    ...
                    <div className="order-0 md:order-1 lg:order-1 xl:order-1 2xl:order-1 object-contain md:w-2/5 xl:w-2/5">
                      <img
