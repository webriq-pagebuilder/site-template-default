              ...
              <div className="w-full lg:w-3/5 flex flex-wrap -mx-3 justify-end">
                ...
                {contacts[0].emailInfo && (
                  <div className="mb-6 w-full md:w-1/2 lg:w-1/4 lg:mr-6 px-3">
                    ...
                    <p className="text-gray-400">{contacts[0]?.emailInfo}</p>
                    <p className="text-gray-400">{contacts[1]?.emailInfo}</p>
                    <p className="text-gray-400">{contacts[2]?.emailInfo}</p>
                  </div>
                )}
                {contacts[0].contactInfo && (
                  <div className="mb-6 w-full md:w-1/2 lg:w-1/4 lg:mr-6 px-3">
                    ...
                    <p className="text-gray-400">{contacts[0]?.contactInfo}</p>
                    <p className="text-gray-400">{contacts[1]?.contactInfo}</p>
                    <p className="text-gray-400">{contacts[2]?.contactInfo}</p>
                  </div>
                )}
              </div>
            )}
            ...
            {socialMedia && (
              <div className="flex space-x-2 lg:space-x-4 mx-24">
                ...
                {socialMedia?.twitterLink && (
                  <a href={socialMedia?.twitterLink}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
