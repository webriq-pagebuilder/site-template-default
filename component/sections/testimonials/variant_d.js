          ...
          <div className="lg:flex items-center justify-center md:space-x-8">
            <div className="mb-10 text-center lg:hidden">
              {testimonials?.length > 1 && (
                <button
                  className="mr-6 lg:mr-0 bg-white p-4 rounded-full shadow-md text-green-600 hover:text-green-400 transition duration-200"
                  onClick={() => slider("prev")}
                >
                  <svg
                    className="w-6 h-6"
              ...
              {testimonials?.length > 1 && (
                <button
                  className="bg-white p-4 rounded-full shadow-md text-green-600 hover:text-green-400 transition duration-200"
                  onClick={() => slider("next")}
                >
                  <svg
                    className="w-6 h-6"
            ...
            {testimonial?.length > 1 && (
              <button
                className="hidden lg:block lg:mr-0 bg-white p-5 rounded-full focus:outline-none  shadow-md text-green-600 hover:text-green-400 transition duration-200"
                onClick={() => slider("prev")}
              >
                <svg
                  className="w-6 h-6"
            ...
            {testimonial?.length > 1 && (
              <button
                className="hidden lg:block bg-white p-5 rounded-full shadow-md focus:outline-none text-green-600 hover:text-green-400 transition duration-200"
                onClick={() => slider("next")}
              >
                <svg
                  className="w-6 h-6"
