...
function VariantB({ caption, title, testimonials }) {
      ...
      <div className="py-20 bg-gray-50 radius-for-skewed overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="pt-8 pb-16 flex flex-wrap justify-center items-center">
            {testimony?.length >= 4 && (
              <button
                className="focus:outline-none mr-3 lg:mr-0 order-last lg:order-first bg-white p-4 rounded-full shadow-md text-green-600 hover:text-green-400 transition duration-200"
                onClick={() => slider("prev")}
              >
                <svg
                  className="w-6 h-6"
            ...
            {testimony?.length >= 4 && (
              <button
                className="focus:outline-none order-last bg-white p-4 rounded-full shadow-md text-green-600 hover:text-green-400 transition duration-200"
                onClick={() => slider("next")}
              >
                <svg
                  className="w-6 h-6"
          ...
          <div className="flex w-full relative">
            <div className="flex justify-center mx-auto">
              {testimonials &&
                testimony?.map(testimonial => (
                  ...
                  {index === 0 ? <div className="hidden lg:block absolute w-1/3 px-3 opacity-50" style={{left: '-370px', top: 0}}>
                    <div className="p-5 bg-white shadow rounded">
                      ...
                      <p className="text-gray-500 leading-loose mb-4">{testimonial?.testimony}</p>
                ...
                :                                  
                index >= 4 ?
                  <div className="hidden lg:block absolute w-1/3 px-3 opacity-50" style={{right: '-370px', top: 0}}>
                    <div className="p-5 bg-white shadow rounded">
                      <svg className="mb-6 text-green-600 h-8" viewBox="0 0 32 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* <div className="mb-4 w-full lg:w-1/3 px-3">
                  <div className="p-5 bg-white shadow rounded">
                    ...
                    <p className="text-gray-500 leading-loose mb-4">Hasellus sollicitudin massa ut quam aliquam, feugiat fringilla est aliquam. Phasellus tincidunt mi a pellentesque fermentum. Quisque vitae erat iaculis, porttitor elit sed, viverra nisl. Maecenas facilisis viverra sollicitudin.</p>
                ...
                <div className="mb-4 w-full lg:w-1/3 px-3">
                  <div className="p-5 bg-white shadow rounded">
                    ...
                    <p className="text-gray-500 leading-loose mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque et placerat metus. Morbi aliquet felis sit amet erat finibus, ac condimentum ligula ornare.</p>
