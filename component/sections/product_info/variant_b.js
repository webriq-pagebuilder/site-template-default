...
function VariantB({
   ...
   const blockStyle = {
      ...
      listItem: {
         bullet: ({ children }) => (
            <li className="mb-6 leading-loose text-gray-900">
               {props.children}
            </li>
         ),
      },
         ...
         <div className="container mx-auto px-4">
            <div className="xl:flex xl:flex-wrap -mx-4">
                     ...
                     <li className="mr-5">
                        {product?.collections?.name && (
                           <a
                              className="inline-block mr-5 text-xs font-bold font-heading uppercase"
                              href={
                                 product?.collections?.slug?.current ?? "/404"
                              }
                           >
                              {product?.collections?.name}
                           </a>
               ...
               <div className="w-full xl:w-1/2 px-4 mb-8 xl:mb-0">
                  <div className="flex gap-3 -mx-1 relative">
                     <Swiper
                        ...
                        className="hidden w-40 md:flex md:flex-wrap thumb-swiper-B"
                        style={{ height: "618px" }}
                     >
                        {images &&
                           images.map((item, index) => (
                              <SwiperSlide
                                 className="hover:border h-full hover:border-gray-400"
                                 key={index}
                              >
                     ...
                     <div className="mt-5">
                        <button
                           id="piprevB"
                           className="absolute z-50 top-60 md:left-32 left-0 ml-5 hover:bg-gray-50 hover:opacity-50 rounded-r-sm rounded-l-md px-2 py-5 transition duration-200"
                        >
                           <svg
                              width={36}
                              height={36}
