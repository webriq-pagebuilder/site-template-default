                ...
                <div className="flex lg:flex-col lg:h-full justify-between">
                  {images?.map((item, index) => (
                    <div
                      ...
                      key={index}
                    >
                      <div className="w-full h-full p-1 lg:p-0 mr-2 lg:mr-0">
                        {item?.image && (
                          <Image
                            layout="responsive"
                            width={126}
          ...
          <div className="w-full pt-20 xl:w-1/2 xl:pt-0 px-4">
            <div>
              ...
              <div className="flex mb-12">
                <div className="mr-6">
                  {/* TO DO: ADD OTHER ELEMENTS FROM ECWID (QUANTITY, SIZE) */}
                </div>
              </div>
              <div className="grid grid-cols-2 gap-x-5 mb-14 items-center">
                {/* Add to cart button */}
                {btnLabel && (
                  <button
                    className="block mb-4 lg:mb-0 text-center text-white font-bold font-heading py-5 px-8 w-full rounded-md uppercase transition duration-200 bg-webriq-darkblue"
                    type="button"
                  >
                    {btnLabel}
                  </button>
                ...
                <button
                  className="flex-shrink-0 flex flex-wrap items-center justify-center py-5 px-8 w-full rounded-md border hover:border-webriq-darkblue"
                  type="button"
                >
                  <svg
                    className="-mt-1 mr-2"
