        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full md:w-1/2 px-4">
            <div>
              ...
              <div className="flex flex-wrap mb-14 items-center gap-x-5">
                {btnLabel && (
                  <button
                    className="block mb-4 lg:mb-0 text-center text-white font-bold font-heading py-5 px-8 rounded-md uppercase transition duration-200 bg-webriq-darkblue"
                    type="button"
                  >
                    {btnLabel}
                  </button>
