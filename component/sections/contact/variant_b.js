        ...
        <div className="container mx-auto px-4">
          {contactDescription && (
            <div className="mb-16 max-w-md mx-auto text-center">
              ...
              <p className="mt-5 text-gray-500">{contactDescription}</p>
            </div>
          )}
            ...
            <div className="mb-8 lg:mb-0 w-full lg:w-1/3 px-4">
              {officeInformation && (
                <div className="py-12 lg:py-20 rounded bg-white shadow text-center">
                  ...
                  <p className="text-gray-400 p-4">{officeInformation}</p>
                </div>
              )}
            </div>
            <div className="mb-8 lg:mb-0 w-full lg:w-1/3 px-4">
              {contactEmail || contactNumber ? (
                <div className="py-12 lg:py-20 rounded bg-white shadow text-center">
                  ...
                  <p className="text-gray-400 p-2">{contactEmail}</p>
                  <p className="text-gray-400 p-2">{contactNumber}</p>
                </div>
              ) : null}
            </div>
            <div className="w-full lg:w-1/3 px-4 flex items-stretch">
              {socialLinks && (
                <div className="py-12 lg:py-20 w-full rounded bg-white shadow text-center">
                  ...
                  <div className="lg:mb-0 order-first lg:order-last">
                    {socialLinks?.fbLink && (
                      <a
                        className="inline-block mr-2 p-2 hover:bg-gray-100 rounded"
