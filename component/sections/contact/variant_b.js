        ...
        <div className="container mx-auto px-4">
          {contactDescription && (
            <div className="mb-16 max-w-md mx-auto text-center">
              <h2 className="mb-5 text-4xl lg:text-5xl font-bold font-heading">
                Contact
              </h2>
                  ...
                  <div className="flex justify-center">
                    {socialLinks?.fbLink && (
                      ...
                      >
                        ...
                        <i aria-hidden="true"></i>Facebook link
                      </a>
                    )}
                    {socialLinks?.twitterLink && (
                      ...
                      >
                        ...
                        <i aria-hidden="true"></i>Twitter link
                      </a>
                    )}
                    {socialLinks?.instagramLink && (
                      ...
                      >
                        ...
                        <i aria-hidden="true"></i>Instagram link
                      </a>
                    )}
                  </div>
                </div>
