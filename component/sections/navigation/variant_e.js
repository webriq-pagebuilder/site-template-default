    ...
    <section className="relative">
      <div className="py-2 bg-webriq-darkblue">
        <div className="flex items-center justify-center">
          ...
          {banner && <PortableText blocks={banner} serializers={blockStyle} />}
        </div>
      </div>
      ...
      <div
        className={`${
          menu ? null : "hidden"
        } fixed top-0 right-0 bottom-0 w-5/6 max-w-sm z-50`}
      >
        <div
        ...
        <nav className="relative flex flex-col py-6 px-6 w-full h-full bg-white border-r overflow-y-auto">
          ...
          <div className="flex mb-8 mx-auto">
            ...
            <button aria-label="cart button" className="mx-10" type="button">
              <svg
                width={23}
                height={23}
                viewBox="0 0 23 23"
