...
export default defineType({
    ...
    sections: [
      {
        ...
        _ref: "6ae70f7e-c9e3-46bf-b91f-9683aac4ea5c", //_ref: "b9355212-053e-4c70-bb9c-c1170f9d46c2" the StackShift default has a different docId for this
      },
    ],
  },
  groups: [
  ...
  fields: [
    defineField({
      ...
      components: {
        input: isCStudio === "true" ? ProductInputComponent : undefined,
      },
      group: "basicInfo",
    }),
    defineField({
    ...
    defineField({
      ...
      description:
        "Add the typical product price without discount or when not on sale",
      readOnly: isCStudio === "true" ? false : true,
