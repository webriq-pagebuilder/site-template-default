...
const meta: Meta<typeof Navigation> & any = {
  title: "Sections/Navigation/Defaults",
  ...
  render: ({ variant, ...args }) => {
    ...
    return <Navigation data={data} template={args.template} />;
  },
} satisfies Meta<typeof Navigation> & any;
