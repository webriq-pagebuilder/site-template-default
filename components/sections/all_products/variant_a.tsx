      ...
      <div className="container mx-auto px-4">
        <div className="mb-5 flex flex-wrap items-center justify-between lg:-mx-4">
          ...
          {!productQuery && products?.length > 1 && (
            <select
              className="rounded-md border border-gray-400 bg-white p-4 text-lg focus:border-primary-foreground focus:ring-primary-foreground"
              name="by-collection"
              value={selectInput}
                    ...
                    >
                      <div className="mx-10">
                        ...
                        >
                          ...
                          {product?.price && (
                            <p className="text-center sm:text-left font-heading text-lg font-bold text-primary">
                              ${product?.price}
                            </p>
                          )}
                        </Link>
