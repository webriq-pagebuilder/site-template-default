    ...
    <section className="bg-gray-50">
      <div className="flex w-full">
        <div className="flex w-1/3">
          <div className="w-1/3 bg-webriq-babyblue py-1" />
          <div className="w-1/3 bg-webriq-blue py-1" />
          <div className="w-1/3 bg-webriq-darkblue py-1" />
        </div>
        <div className="flex w-1/3">
          <div className="w-1/3 bg-webriq-babyblue py-1" />
          <div className="w-1/3 bg-webriq-blue py-1" />
      ...
      <div className="container mx-auto px-4">
        <div className="pb-12 pt-10">
          <div className="relative mb-8 flex flex-wrap lg:border-b lg:border-gray-300 lg:pb-8">
            <p className="order-last w-full text-center text-sm text-gray-900 lg:order-first lg:w-auto lg:text-left">
              {copyright}
            </p>
            {menu && (
              <div className="mx-auto mb-6 lg:absolute lg:left-1/2 lg:mb-0 lg:-translate-x-1/2 lg:transform">
                <ul className="mx-20 flex flex-wrap items-center justify-between lg:space-x-5">
                  {menu?.map((links, index) => (
                    <li className="mb-2 w-full md:mb-0 md:w-auto" key={index}>
                      <ConditionalBtnOrLink
                        value={links}
                        style="mr-6 text-sm hover:text-gray-500"
                      />
                    </li>
                  ))}
                </ul>
