		...
		<section>
			<div className="radius-for-skewed bg-gray-50 py-20">
				<div className="container mx-auto px-4">
					<div className="flex flex-wrap items-center justify-between border-b border-gray-100 pb-12">
						<div className="mx-20 mb-12 w-full lg:mb-4 lg:w-1/5">
							{logo?.image && (
								<Link
									aria-label={
										logoLink(logo) === "/"
						...
						{menu && (
							<div className="w-full lg:w-auto">
								<ul className="mx-20 mt-8 flex flex-wrap items-center justify-between lg:space-x-5">
										...
										<React.Fragment key={links?._key || index}>
											...
											{index + 1 !== length ? (
												<li className="hidden md:block">
													<svg
														className="mx-4 h-4 w-4 text-gray-500"
					...
					<div className="mx-20 mt-8 flex flex-wrap items-center justify-between">
