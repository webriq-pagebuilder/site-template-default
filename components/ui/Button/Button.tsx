...
export function Button({
  ...
  const outline = `${commonStyles} bg-brand-secondary hover:bg-brand-secondary-foreground font-bold border text-webriq-blue border-webriq-blue `;
  const secondary = `${commonStyles} bg-secondary hover:bg-secondary-foreground font-bold  text-gray-50`;
