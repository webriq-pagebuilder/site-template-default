      ...
      {!breakpoint && !sectionsWithoutEditor?.includes(document?.type) && (
        <div className="absolute top-0 left-0 w-full h-full p-4 text-right pointer-events-none">
          <button
            ...
            variant="outline"
            id={document?.type}
            className={`pointer-events-auto bg-white border z-40 items-center px-2 py-2.5 text-center text-sm font-medium text-primary shadow-lg hover:border-primary-foreground hover:bg-primary-foreground hover:text-white rounded-none ${
