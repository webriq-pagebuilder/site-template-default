...
export default function resolveProductionUrl(doc: SanityDocumentLike & { slug?: { current: string } }, inStudioWebPreview?: boolean) {
...
export function PreviewURL(siteUrl: string, previewSecret: string, documentType: string, slug: string, inStudioWebPreview?: boolean) {
