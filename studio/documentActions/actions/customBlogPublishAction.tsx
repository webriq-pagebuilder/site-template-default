  ...
  return {
    ...
    onHandle: async () => {
      ...
      try {
        ...
        // Gated on WEBHOOK_INCLUDED_TYPES (shared with createProductsPublishAction
        // and the PF webhook route) so the allow-list is the single source of truth.
        ...
        if (
          PUBLISHFORGE_WEBHOOK_URL &&
          WEBHOOK_INCLUDED_TYPES.has(props.type)
        ) {
