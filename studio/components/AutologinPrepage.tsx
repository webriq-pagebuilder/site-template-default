  ...
  if(status === "retry") {
    return (
      <div className="py-24 text-center justify-center h-full translate-">
        <h1 className="font-bold text-lg sm:text-2xl mt-20 mb-5">Logging in to WebriQ Studio</h1>
    ...
    return (
      <div className="py-20 text-center justify-center h-full">
        ...
        />
        <h1 className="font-bold text-lg sm:text-2xl mb-5">Oops, unable to autologin!</h1>
