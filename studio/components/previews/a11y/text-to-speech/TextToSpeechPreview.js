    ...
    return (
      <div className="wrapper">
        <Flex>
          ...
          <Card marginX={2}>
            <Flex>
              <Button mode="default" tone="primary" type="button" onClick={handleStartSpeaking}>Play</Button>
              <Button mode="default" type="button" onClick={handleStopSpeaking} style={{ backgroundColor: "#f03e2f", color: "#fff", borderColor: "transparent" }}>
                Stop
              </Button>
            </Flex>
          </Card>
        ...
        <p className="transcriptBody">{textToSpeak()}</p>
      </div>
    )
  }
